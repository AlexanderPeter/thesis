...
% Analysing similarity mays bring valuable insights how such a similarity can be measured and potentially even be applied to check which images within a dataset are better suited.
