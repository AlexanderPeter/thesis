...
\end{equation}
The computational complexity of this closed solution is nearly cubic $\mathcal{O}(n^3)$ due to the calculating of the matrix inverse, making it unfeasible for almost all datasets \autocite{riahi2023}. Therefore   
