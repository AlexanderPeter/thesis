...
%TODO Consider moving into result tables
...
\subsection{Detailed results}\label{appendix:detailed_results}

%TODO Consider merging all plant and all derma results
...
\stepcounter{footnote}\footnotetext{https://www.aicrowd.com/challenges/lifeclef-2022-23-plant}% chktex 8
...
\includepdf[pages=-,addtotoc={1, section, 1, Task description, task description}]{../../documents/task_description_printed.pdf}\label{appendix:task_description}

\section{Meeting notes}%\label{section:meeting_notes}
% textidote: ignore begin
