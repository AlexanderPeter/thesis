...
Resnet50 & Random & torchvision.models.resnet50 \tabularnewline \hline
...
Additionally the class ``Nevi'' dominates the other classes. Lastly the two classes ``Dermatofibroma'' and ``Vascular'' do not have enough samples for subsampling 30 datapoints per class.
\begin{figure}[H]
    \begin{center}
...
Beside \gls{ddi} this data set also provides more than one possivle target class. In this work the following three classes were used. This can also be seen on Figure~\ref{fig:class_distribution_of_fitzpatrick17k}.
