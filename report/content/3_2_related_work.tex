...
\autocite{raghu2019} also shows that only certain layer benefit from pretrained weights while others should be initialized randomly.
% No general claim is possible.
...
% suggests that the utility of self-supervised pretraining comes mainly from better regularization that reduces overfitting, not better optimization
